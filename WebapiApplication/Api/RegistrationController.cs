...
namespace WebapiApplication.Api
{
    public class RegistrationController : ApiController
    {
        ...
        public int getUpdateEmplogintoCustomersite(int empid, string ProfileID, string Narration) { return this.IRegistration.UpdateEmplogintoCustomersite(empid,ProfileID,Narration); }
    }
}