...
namespace WebapiApplication.Api
{
    public class CustomerPersonalController : ApiController
    {
        ...
        public ArrayList getCustomerPersonalContact_Details([FromUri]long? CustID) { return this.ICustomerpersonal.getCustomerPersonalContact_Details(CustID); }
        public ArrayList getCustomerPersonaloffice_purpose([FromUri] string flag, [FromUri]string ID, [FromUri] string AboutProfile, [FromUri] int? IsConfidential, [FromUri] int? HighConfendential) { return this.ICustomerpersonal.getCustomerPersonaloffice_purpose(flag, ID, AboutProfile, IsConfidential, HighConfendential); }
        public ArrayList getCustomerprofilesettingDetails([FromUri]long? CustID) { return this.ICustomerpersonal.CustomerprofilesettingDetails(CustID); }
        ...
        public int getCandidateContactsendmailtoemailverify(long? CustID) { return this.ICustomerpersonal.CandidateContactsendmailtoemailverify(CustID); }

        public ArrayList getProfileIDPlaybutton(string ProfileID) { return this.ICustomerpersonal.ProfileIDPlaybutton(ProfileID); }
        public ArrayList getViewAllCustomersSettledeleteinfo(string CustID, string typeofdata) { return this.ICustomerpersonal.ViewAllCustomersSettledeleteinfo(CustID, typeofdata); }
