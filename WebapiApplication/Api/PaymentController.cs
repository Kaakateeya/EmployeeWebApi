...
namespace WebapiApplication.Api
{
    public class PaymentController : ApiController
    {
        ...
        public PaymentController()
            : base()
        {
            this.IPayment = new ImpPayment();
        }

        public List<Paymentselect> GetPaymentDetails(long? CustID)
        {
            return this.IPayment.GetPaymentDetails(CustID);
        }

        public string getCustomerPaymentStatus(long? CustomerCustID)
        {
            return this.IPayment.CustomerPaymentStatus(CustomerCustID);
        }

        public int InsertPaymentDetails([FromBody]PaymentMasterMl Mobj)
        {
            return this.IPayment.InsertPaymentDetails(Mobj);
        }

        public ArrayList getProfilePaymentDetails(long? intProfileID, int? Isonline, int? flag, int? intMembershipID, string taxpaid)
        {
            return this.IPayment.ProfilePaymentDetails(intProfileID, Isonline, flag, intMembershipID, taxpaid);
        }
        ...
        public ArrayList getProfilePaymentDetailsGridview(string intProfileID)
        {
            return this.IPayment.ProfilePaymentDetails_Gridview(intProfileID);
        }

        public ArrayList getProfilePaymentDetails_NewDesigns(string intProfileID, int intPaymentHistID)
        {
            return this.IPayment.DgetProfilePaymentDetails_NewDesigns(intProfileID, intPaymentHistID);
        }
