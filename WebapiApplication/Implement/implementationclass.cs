...
namespace WebapiApplication.Implement
{
    ...
    public class ImpPayment : IPayment
    {
        ...
        public ArrayList DgetProfilePaymentDetails_NewDesigns(string intProfileID, int intPaymentHistID) { return new PaymentDAL().DgetProfilePaymentDetails_NewDesigns(intProfileID,intPaymentHistID, "[dbo].[usp_Payment_getProfilePaymentDetails_NewDesigns]"); }
