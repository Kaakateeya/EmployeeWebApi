...
namespace WebapiApplication.Implement
{
    ...
    public class ImpMobileApp : IMobileAppDev
    {
        ...
        public ArrayList MobileLandingOrderDisplay(long? CustID, int? Startindex, int? EndIndex) { return new MobileAppDal().MobileLandingOrderDisplay( CustID,  Startindex,  EndIndex, "[dbo].[usp_LandingOrderDisplay_MobileApp]"); }
