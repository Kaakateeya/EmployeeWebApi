...
namespace WebapiApplication.Implement
{
    public class ImpRegistration : IRegistration
    {
        ...
        public ArrayList EmployeeRegisterCustomerHomepages(PrimaryInformationMl Mobj) { return new RegistrationDAL().EmployeeRegisterCustomerHomepages(Mobj, "[dbo].[usp_Cust_QuickRegistration_Customer]"); }

        public int CustomerRegProfileDetails_Myprofile(UpdatePersonaldetails Mobj) { return new RegistrationDAL().DgetCustomerRegProfileDetails_Myprofile(Mobj, "[dbo].[usp_CustomerRegProfiledetails-Customer]"); }
