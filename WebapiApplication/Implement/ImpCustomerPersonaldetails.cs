...
namespace WebapiApplication.Implement
{
    ...
    public class ImpCustomerPersonaldetailsUpdate : ICustomerPersonaldetailsUpdate
    {
        ...
        public ArrayList Emplanding_counts_Admin(EmployeeLandingCount ecount) { return customerdetails.Emplanding_counts_Admin(ecount, "[dbo].[usp_emplanding_counts_Admin_New]"); }//usp_emplanding_counts_Admin_New

        public ArrayList Emplanding_counts_TablesDisplay(EmployeeLandingCount ecount) { return customerdetails.Emplanding_counts_TablesDisplay(ecount, "[dbo].[usp_emplanding_counts_Admin_New]"); }//usp_emplanding_counts_Admin_New
