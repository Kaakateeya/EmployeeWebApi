...
namespace WebapiApplication.Implement
{
    public class ImpStaticPages : IStaticPages
    {
        ...
        public ArrayList Cust_NotificationDetails_Employee(int? EmpID, int? idisplay, int? NotificationID, int? CategoryID, int? CustID) { return new StaticPagesDAL().Cust_NotificationDetails_Employee(EmpID, idisplay, NotificationID, CategoryID, CustID, "[dbo].[usp_GetNotificationdetails_Emp]"); }
        ...
        public ArrayList EmployeeLoginCoutDetails() { return new StaticPagesDAL().EmployeeLoginCoutDetails("[dbo].[Usp_GetDetailedLogInfo_Employees]"); }
