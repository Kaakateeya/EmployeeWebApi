...
namespace WebapiApplication.Implement
{
    public class ImpStaticPages : IStaticPages
    {
        ...
        public ArrayList CustomerUnauthorizedPayments(string BranchID, string StartDate, string EndDate, string Region, string strProfileID) { return new StaticPagesDAL().CustomerUnauthorizedPayments(BranchID, StartDate, EndDate, Region,strProfileID, "[dbo].[usp_get_CustUnauthorizedPaymentDetails_NewDesign]"); }
